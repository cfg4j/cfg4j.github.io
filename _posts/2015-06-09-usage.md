...
public class Cfg4jPoweredApplication {
  ...
  public static void main(String... args) {
    ...
    // Get info about "Reksio" dog. When you add more friends in the configuration file object below will automatically reflect that change (by refreshing friends() list).
