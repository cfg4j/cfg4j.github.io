...
Once you have your configuration in place, create a ```ConfigurationSource`` object that will fetch it.

To learn more about supported configuration sources and their capabilities head down to the [PLUGINS section](#plugins).
