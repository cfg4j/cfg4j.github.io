...
# Quick start
-------------------------
You may want to read [the following (a bit lenghty) article about configuration management using cfg4j](http://potocki.io/post/141230472743/configuration-management-for-distributed-systems)
